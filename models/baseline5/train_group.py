...
from model import PersonActivityTemporalClassifier, Group_Activity_Classifer
...
# Use in group model
model = Group_Activity_Classifer(person_model, num_classes=8)
model.to(device)
...
log_dir = f"/mnt/New Volume/Deep Learning. DR Mostafa/Group_Activity_Recognition/models/baseline5/outputs/tensorbord/baseline4_group{timestamp}"
...
for epoch in range(EPOCHS):
    ...
    if avg_vloss < best_vloss:
        ...
        model_save_dir = "/mnt/New Volume/Deep Learning. DR Mostafa/Group_Activity_Recognition/models/baseline5/outputs/trained_model/group/"
