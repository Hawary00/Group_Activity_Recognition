...
# Define Model
model = Person_Activity_Temporal_Classifer(num_classes=9, hidden_size=512,
                                            num_layers=1)
model.to(device)
...
log_dir = f"/mnt/New Volume/Deep Learning. DR Mostafa/Group_Activity_Recognition/models/baseline7/outputs/tensorbord/baseline7_a_{timestamp}"
...
for epoch in range(EPOCHS):
    ...
    if avg_vloss < best_vloss:
        ...
        model_save_dir = "/mnt/New Volume/Deep Learning. DR Mostafa/Group_Activity_Recognition/models/baseline7/outputs/trained_model/a/"
