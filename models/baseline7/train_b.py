...
# Loss Function
loss_fun = torch.nn.CrossEntropyLoss(ignore_index=-100, label_smoothing=0.10)
...
person_model = Person_Activity_Temporal_Classifer(num_classes=9, hidden_size=512, num_layers=1)
...
log_dir = f"/mnt/New Volume/Deep Learning. DR Mostafa/Group_Activity_Recognition/models/baseline7/outputs/tensorbord/baseline7_b_{timestamp}"
...
for epoch in range(EPOCHS):
    ...
    if avg_vloss < best_vloss:
        ...
        model_save_dir = "/mnt/New Volume/Deep Learning. DR Mostafa/Group_Activity_Recognition/models/baseline7/outputs/trained_model/b/"
