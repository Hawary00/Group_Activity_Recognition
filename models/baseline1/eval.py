...
saved_model_path = "D:\Deep Learning. DR Mostafa\Group_Activity_Recognition\models\baseline1\outputs\trained_model\model_20250216_184456_4"
saved_model = b1_classifier(8)
saved_model.load_state_dict(torch.load(saved_model_path))
saved_model.to(device)

save_path = "/mnt/New Volume/Deep Learning. DR Mostafa/Group_activity_project/models/baseline1/outputs/confusion_matrix.png"  # Change to your desired path
