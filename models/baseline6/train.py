...
# Load person model
saved_person_model_baseline3_path = "/mnt/New Volume/Deep Learning. DR Mostafa/Group_Activity_Recognition/models/baseline2/model_20250309_005202_4" # take the model from baseline2 #make sure to select right path
...
# Define Model
model = Group_Activity_Classifer_Temporal(num_classes=8,
...
log_dir = f"/mnt/New Volume/Deep Learning. DR Mostafa/Group_Activity_Recognition/models/baseline6/outputs/tensorbord/baseline6_{timestamp}"
...
for epoch in range(EPOCHS):
    ...
    # avg_vloss = train_one_epoch(epoch_number, writer)
    train_loss, train_acc = train_one_epoch(epoch_number, writer)
    ...
    { 'Training': float(train_loss), 'Validation': avg_vloss.item() },
    epoch_number + 1)
    ...
    if avg_vloss < best_vloss:
        ...
        model_save_dir = "/mnt/New Volume/Deep Learning. DR Mostafa/Group_Activity_Recognition/models/baseline6/outputs/trained_model"
