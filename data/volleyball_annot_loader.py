...
dataset_root = r"/mnt/New Volume/Deep Learning. DR Mostafa/05- Project 1 - CV/volleyball-datasets"
...
if __name__ == '__main__':
    ...
    clip_dir_path = os.path.dirname(annot_file).replace('volleyball_tracking_annotation', 'volleyball_/videos')
